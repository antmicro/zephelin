...
#define TVMGEN_SINE2_FUNCTIONS(FUNC)		\
	FUNC(tvmgen_sine2_fused_nn_dense_subtract_add_fixed_point_multiply_add_clip_cast) \
	FUNC(tvmgen_sine2_fused_nn_dense_subtract_add_fixed_point_multiply_add_clip_cast_1) \
	FUNC(tvmgen_sine2_fused_nn_dense_subtract_add_fixed_point_multiply_add_clip_cast_2) \
	FUNC(tvmgen_sine2_fused_reshape) \
	FUNC(tvmgen_sine2_fused_reshape_1)
...
const TVMBackendPackedCFunc tvm_sine2_func_array[] = {TVMGEN_SINE2_FUNCTIONS(TVMGEN_SINE2_FUNC_ARRAY)};

const TVMFuncRegistry tvm_sine2_func_reg = {.names = TVMGEN_SINE2_FUNCTIONS_COUNT TVMGEN_SINE2_FUNCTIONS(TVMGEN_SINE2_FUNC_REGISTRY) "\0",
	.funcs = tvm_sine2_func_array};

const TVMModule g_tvm_sine2_module = {&tvm_sine2_func_reg};

const TVMModule *TVMSine2LibEntryPoint(void) { return &g_tvm_sine2_module; }
