...
Should Display TFLM and TVM OP Name
	...
	Wait For Trace On Uart	zpl_tflm_enter	subgraph_idx=${0}	op_idx=${0}	tag=FULLY_CONNECTED	thread_id=any	arena_used_bytes=any	arena_tail_usage=any
	...
	Wait For Trace On Uart	zpl_inference_exit	model_id=any
	Wait For Trace On Uart	zpl_inference_enter	model_id=any
	Wait For Trace On Uart	zpl_tvm_enter	op_idx=${6}	tag=tvmgen_quantized_fused_nn_dense_subtract_add_fixed_point_multiply_add_clip_cast
	...
	Wait For Trace On Uart	zpl_inference_exit	model_id=any
	Wait For Trace On Uart	zpl_inference_enter	model_id=any
	Wait For Trace On Uart	zpl_tvm_enter	op_idx=${6}	tag=tvmgen_sine2_fused_nn_dense_subtract_add_fixed_point_multiply_add_clip_cast
	Wait For Trace On Uart	zpl_tvm_exit	op_idx=${6}	tag=tvmgen_sine2_fused_nn_dense_subtract_add_fixed_point_multiply_add_clip_cast
	Wait For Trace On Uart	zpl_tvm_enter	op_idx=${11}	tag=tvmgen_sine2_fused_nn_dense_subtract_add_fixed_point_multiply_add_clip_cast_1
	Wait For Trace On Uart	zpl_tvm_exit	op_idx=${11}	tag=tvmgen_sine2_fused_nn_dense_subtract_add_fixed_point_multiply_add_clip_cast_1
	Wait For Trace On Uart	zpl_tvm_enter	op_idx=${16}	tag=tvmgen_sine2_fused_nn_dense_subtract_add_fixed_point_multiply_add_clip_cast_2
	Wait For Trace On Uart	zpl_tvm_exit	op_idx=${16}	tag=tvmgen_sine2_fused_nn_dense_subtract_add_fixed_point_multiply_add_clip_cast_2
	Wait For Trace On Uart	zpl_inference_exit	model_id=any
