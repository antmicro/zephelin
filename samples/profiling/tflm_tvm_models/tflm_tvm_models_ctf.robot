...
Should Display TFLM and TVM OP Name
	...
	Wait For Trace On Uart	zpl_inference_exit	model_id=any
	Wait For Trace On Uart	zpl_inference_enter	model_id=any
	Wait For Trace On Uart	zpl_tvm_enter	op_idx=${2}	tag=tvmgen_quantized_fused_reshape_cast_subtract
	...
	Wait For Trace On Uart	zpl_inference_exit	model_id=any
	Wait For Trace On Uart	zpl_inference_enter	model_id=any
	Wait For Trace On Uart	zpl_tvm_enter	op_idx=${2}	tag=tvmgen_sine2_fused_reshape_cast_subtract
