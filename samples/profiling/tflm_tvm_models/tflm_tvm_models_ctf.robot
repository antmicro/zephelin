...
Should Display TFLM and TVM OP Name
	...
	Wait For Trace On Uart	zpl_tflm_enter	subgraph_idx=${0}	op_idx=${0}	tag=FULLY_CONNECTED	thread_id=any	arena_used_bytes=any	arena_tail_usage=any	timeout=30
	...
	Wait For Trace On Uart	zpl_inference_exit	model_id=any
	Wait For Trace On Uart	zpl_inference_enter	model_id=any
	Wait For Trace On Uart	zpl_tvm_enter	op_idx=${2}	tag=tvmgen_sine2_fused_reshape_cast_subtract	timeout=30
