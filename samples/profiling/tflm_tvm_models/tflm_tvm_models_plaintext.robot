...
Should Display TFLM and TVM Events
	...
	Wait For Line On Uart	zpl_inference_exit: model_id
	Wait For Line On Uart	zpl_inference_enter: model_id
	Wait For Line On Uart	zpl_tvm_enter_event: op_idx=2 tag=tvmgen_sine2_fused_reshape_cast_subtract
	Wait For Line On Uart	zpl_tvm_exit_event: op_idx=2 tag=tvmgen_sine2_fused_reshape_cast_subtract
	Wait For Line On Uart	zpl_tvm_enter_event: op_idx=6 tag=tvmgen_sine2_fused_nn_dense_add_fixed_point_multiply_add_clip_cast
	Wait For Line On Uart	zpl_tvm_exit_event: op_idx=6 tag=tvmgen_sine2_fused_nn_dense_add_fixed_point_multiply_add_clip_cast
	Wait For Line On Uart	zpl_tvm_enter_event: op_idx=7 tag=tvmgen_sine2_fused_reshape_cast_subtract_1
	Wait For Line On Uart	zpl_tvm_exit_event: op_idx=7 tag=tvmgen_sine2_fused_reshape_cast_subtract_1
	Wait For Line On Uart	zpl_tvm_enter_event: op_idx=10 tag=tvmgen_sine2_fused_nn_dense_add_fixed_point_multiply_add_clip_cast_1
	Wait For Line On Uart	zpl_tvm_exit_event: op_idx=10 tag=tvmgen_sine2_fused_nn_dense_add_fixed_point_multiply_add_clip_cast_1
	Wait For Line On Uart	zpl_tvm_enter_event: op_idx=11 tag=tvmgen_sine2_fused_reshape_cast_subtract_1
	Wait For Line On Uart	zpl_tvm_exit_event: op_idx=11 tag=tvmgen_sine2_fused_reshape_cast_subtract_1
	Wait For Line On Uart	zpl_tvm_enter_event: op_idx=14 tag=tvmgen_sine2_fused_nn_dense_add_fixed_point_multiply_add_clip_cast_2
	Wait For Line On Uart	zpl_tvm_exit_event: op_idx=14 tag=tvmgen_sine2_fused_nn_dense_add_fixed_point_multiply_add_clip_cast_2
	Wait For Line On Uart	zpl_inference_exit: model_id
